...
const ProfileDropdown = () => {
  ...
  const user = JSON.parse(localStorage.getItem('user')) || { name: 'Kim Namjoon', email: 'kim@syncnode.com', plan: 'Pro Plan' };
    ...
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-64 bg-white rounded-2xl border border-gray-100 shadow-[0_20px_60px_-15px_rgba(0,30,43,0.1)] overflow-hidden z-50 animate-in fade-in slide-in-from-top-2">
          ...
          <div className="p-5 bg-gradient-to-b from-gray-50/80 to-white border-b border-gray-50">
            <p className="font-bold text-[#001E2B] text-sm">{user.name}</p>
